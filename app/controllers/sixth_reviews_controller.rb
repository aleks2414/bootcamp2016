  ...
  def create
    ...
    respond_to do |format|
      if @sixth_review.save
        format.html { redirect_to @sixth_review, notice: 'Sixth review was successfully created.' }
        format.json { render :show, status: :created, location: @sixth_review }
      else
  ...
  def update
    respond_to do |format|
      if @sixth_review.update(sixth_review_params)
        format.html { redirect_to @sixth_review, notice: 'Sixth review was successfully updated.' }
        format.json { render :show, status: :ok, location: @sixth_review }
      else
